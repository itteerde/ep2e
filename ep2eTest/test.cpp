...
TEST(ep2e, is_critical) {
	...
	EXPECT_FALSE(ep2e::is_critical(60));
...
TEST(ep2e, opposed_test) {
	...
	EXPECT_EQ(ep2e::opposed_test(80, 80, 60, 60, false, false), 0);
	...
	EXPECT_EQ(ep2e::opposed_test(80, 70, 7, 67, true, true), 1);
	EXPECT_EQ(ep2e::opposed_test(80, 77, 7, 67, true, true), 0);
